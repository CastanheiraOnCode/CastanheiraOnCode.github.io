...
import { PointsMaterial, Color, AdditiveBlending, Vector3, BufferAttribute, BufferGeometry, Points } from 'three';
...
let collisionEnabled = true; // Variable to track collision checking
...
// Update the heart mesh position to always be in front of the camera
